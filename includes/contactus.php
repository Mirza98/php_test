...
<head>
 ...
 <link href="styleadvert2.css" rel="stylesheet" type="text/css"/>
...
<script type="text/javascript" src="javascriptsidebar.js"></script>
...
?>
	...
	<div id="contact">
		...
		if (isset($_POST['contact_submit'])) {
			...
			if (!$name || !$email || !$msg) {
				echo '<h4 class="error">All fields required.</h4><a href="contactus.php" class="button block">Go back and try again</a>';
				exit;
			}
			
			// Add the recipient email to a variable
			$to	= "mirzaaaa1998@gmail.com";
		...
		<p><a href="mysite.php" class="button block">&laquo; Go to Home Page</a></p>
...
<?php include('specialdivfooter.php'); ?>
